...
<body>
 <div class="container-fluid alert alert-danger mydiv">
 ...
 if(isset($_POST['submit'])){
   ...
   $query="INSERT INTO hotelform(name, lname,email,phone,street,city,state, pin,contry,arrdate,dedate,noadd,nokid,nonight,roompre,sperequest) values('$name','$lname','$email','$phone','$street','$city','$state','$pin','$contry','$arrivaldate','$depdate','$noofadult','$noofkid','$noofnight','$roompre','$special')" ;
